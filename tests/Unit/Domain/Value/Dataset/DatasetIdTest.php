...
namespace Datana\Iusta\Api\Tests\Unit\Domain\Value\Dataset;
...
/**
 * @covers \Datana\Iusta\Api\Domain\Value\Dataset\DatasetAbstractId
 */
final class DatasetIdTest extends TestCase
{
    ...
    {
        $id = new DatasetAbstractId($value);
